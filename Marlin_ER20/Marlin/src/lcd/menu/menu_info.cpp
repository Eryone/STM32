...
//
void menu_self_test() {
//  ui.defer_status_screen(true); // disable timeout to status screen.
...
//  if (ui.use_click()) 
 ...
 MenuItem_confirm::select_screen(
            PSTR("YES"),PSTR("NO"),
            adjust_z_move, ui.goto_previous_screen,
...
void menu_info() {
 // adust_z_ing=0;
  ...
  BACK_ITEM(MSG_MAIN);
    ...
    #endif
   // SUBMENU(MSG_SELF_TEST, menu_self_test);               // Self Test >

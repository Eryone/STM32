...
#define STRING_CONFIG_H_AUTHOR "(Eryone3d)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ERYONE_MINI//SDFSDFSDF
#endif
...
#define TEMP_SENSOR_CHAMBER 13 //0
#define TEMP_SENSOR_COOLER 0 //13
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
 ...
 // #endif
   ...
   #define DEFAULT_Ki   1.54 //2.01
   #define DEFAULT_Kd  76.55 //85.00
#else
   #define DEFAULT_Kp  26.11
   #define DEFAULT_Ki   2.01
   #define DEFAULT_Kd  85.00
 ...
 */
#ifdef ER20_Direct
  #define DEFAULT_MAX_FEEDRATE          { 100, 100, 5, 100 } //{ 200, 200, 10, 100 }
#else
 ...
 */
#ifdef ER20_Direct
  #define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 25, 10000 } //{ 3000, 3000, 100, 10000 }
#else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, 0 ,-2.6 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 34  // X point for Z homing

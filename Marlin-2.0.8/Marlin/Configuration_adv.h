 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 90 //60        // Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 18 //10     // Degrees Celsius
...
#define CHAMBER_AUTO_FAN_PIN PB9 //-1
#define COOLER_AUTO_FAN_PIN -1
#define COOLER_FAN_PIN -1

#define EXTRUDER_AUTO_FAN_TEMPERATURE 50
#define EXTRUDER_AUTO_FAN_SPEED 255   // 255 == full speed
#define CHAMBER_AUTO_FAN_TEMPERATURE 20 //40
#define CHAMBER_AUTO_FAN_SPEED 200 //130
#define COOLER_AUTO_FAN_TEMPERATURE 20 //40
#define COOLER_AUTO_FAN_SPEED 200 //130
...
#define HOMING_BUMP_MM      { 6, 6, 1 }       // (mm) Backoff from endstops after first bump
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.00 //0.22    // Unit: mm compression per 1mm/s extruder speed
...
#define ADVANCED_PAUSE_FEATURE
    ...
    #define FILAMENT_CHANGE_UNLOAD_LENGTH      30 //100  // (mm) The length of filament for a complete unload.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       700 //800        // (mA) RMS current. Multiply by 1.414 for peak current.
